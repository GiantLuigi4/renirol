...
public class IBOs {
    public static void main(String[] args) {
        long start = PerformanceCounters.GetTickCount();
        ...
        Shader VERT = new Shader(
                ...
                read(IBOs.class.getClassLoader().getResourceAsStream("test/vbo/shader.vert")),
        ...
        Shader FRAG = new Shader(
                compiler,
                ReniSetup.GRAPHICS_CONTEXT.getLogical(),
                read(IBOs.class.getClassLoader().getResourceAsStream("test/vbo/shader.frag")),
        ...
        ByteBuffer indices = ibo.createByteBuf();
